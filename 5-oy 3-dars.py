...
cursor.execute('''
    ...
    VALUES 
        ('Toshkent Oliy Talim Maktabi', 'Toshkent, Amir Temur kochasi 25', '998711234567', TRUE),
        ('Orta Maktab', 'Toshkent, Chorsu kochasi 10', '998711234568', FALSE),
        ('Yoshlar Texnik Maktabi', 'Toshkent, Navoiy kochasi 45', '998711234569', TRUE),
        ('Bukhara International School', 'Buxoro, Mustaqillik kochasi 80', '998654321987', FALSE),
        ('Samarkand Science School', 'Samarkand, Bobur kochasi 12', '998937654321', TRUE)
    ;  
''')
